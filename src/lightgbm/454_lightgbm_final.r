...
PARAM$finalmodel$num_iterations <- 1128
PARAM$finalmodel$learning_rate <- 0.0106740561
PARAM$finalmodel$feature_fraction <- 0.3168338360
PARAM$finalmodel$min_data_in_leaf <- 1201
PARAM$finalmodel$num_leaves <- 524
