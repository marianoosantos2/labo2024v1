...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/10-NBline-ml-2col/"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001", "competencia_2024_2.csv.gz")
...
corrida_guantesblancos_202109( "NBline-ML-2col-01" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "NBline-ML-2col-01" )
