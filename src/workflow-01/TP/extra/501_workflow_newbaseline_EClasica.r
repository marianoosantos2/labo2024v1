...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/09-Nbline-Eclasica/"
...
# por favor notal como este script parte de FE0035

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  
  # Ya tengo corrido FE0035 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0036", "FE0035" )
  
  HT_tuning_guantesblancos( "HT0036", "TS0036" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0036", c("HT0036", "TS0036") )
...
corrida_guantesblancos_202109( "NBL-Ecla-01" )


# Luego partiendo de  FE0035
# genero TS0036, HT0036 y ZZ0036

corrida_guantesblancos_202107( "NBL-Ecla-02" )
