...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/001-comp-09/"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 
                               202007, 202009, 202010, 202011, 202012,  202102, 202103, 202104, 202105, 202106, 202107)


  param_local$train$training <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 
                                  202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
  param_local$train$validation <- c(202106)
  param_local$train$testing <- c(202107)

  # undersampling  baseline
  param_local$train$undersampling <- 0.11
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = c( 0.2, 0.8 ),
    feature_fraction = c( 0.45, 0.85 ),
    num_leaves = c( 80L, 1200L,  "integer" ),
    min_data_in_leaf = c( 2900L, 5000L, "integer" )
  )
...
corrida_baseline_semillerio_202109( "semillerio-super" )
