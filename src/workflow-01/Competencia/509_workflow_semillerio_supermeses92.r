...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/ultimo/"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009,202008,202007,202006,202005)
  
  
  param_local$train$training <- c(202105,202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002)
...
ZZ_final_semillerio_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  # El parametro fundamental de canarerio
