...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/001-comp-06/"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201910, 201911, 201912,  202002, 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107)


  param_local$train$training <- c(201908, 201909, 201910, 201911, 201912,  202002, 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = c( 0.1, 0.7 ),
    feature_fraction = c( 0.4, 0.7 ),
    num_leaves = c( 80L, 1000L,  "integer" ),
    min_data_in_leaf = c( 1500L, 5000L, "integer" )
  )
