...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/001-comp-11/"
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201911, 201912,  202002, 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107)
  
  
  param_local$train$training <- c(201909, 201910, 201911, 201912,  202002, 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 100L, 2048L,  "integer" ),
    min_data_in_leaf = c( 800L, 2000L, "integer" )
  )
...
corrida_guantesblancos_202109( "old01" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_guantesblancos_202107( "SINNA02" )
