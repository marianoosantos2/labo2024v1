...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/001-comp-01/"
...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/531_DR_corregir_drifting_NA.r"
...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/541_FE_historia_baseline.r"
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202004, 202005, 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011)
  
  
  param_local$train$training <- c(202008, 202007, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009)
  ...
  param_local$train$undersampling <- 0.14
