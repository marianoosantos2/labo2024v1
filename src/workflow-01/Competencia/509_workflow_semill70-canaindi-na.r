...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/001-comp-04/"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201910, 201911, 202002, 202003, 202008, 202009, 202010, 202011, 202101, 202102, 202103, 202104, 202105, 202106, 202107)


  param_local$train$training <- c(201908, 201909, 201910, 201911, 202002, 202003, 202008, 202009, 202010, 202011, 202101, 202102, 202103, 202104, 202105)
  param_local$train$validation <- c(202106)
  param_local$train$testing <- c(202107)

  # undersampling  baseline
  param_local$train$undersampling <- 0.12
...
TS_strategy_baseline_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202008, 202007, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009)


  param_local$train$training <- c(202005, 202004, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = c( 0.5, 0.7 ),
    feature_fraction = c( 0.4, 0.7 ),
    num_leaves = c( 80L, 1500,  "integer" ),
    min_data_in_leaf = c( 2900, 3000L, "integer" )
  )
...
corrida_baseline_semillerio_202109( "01-comp-04semill70-canaindi-na" )
