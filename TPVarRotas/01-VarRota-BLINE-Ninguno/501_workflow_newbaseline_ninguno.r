...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/06-NBlin-ninguno/"
...
corrida_guantesblancos_202109( "exp_07-Nbline-ninguno-01" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "exp_07-Nbline-ninguno-01" )
